  ...
  return toast.custom(
    (currentToast) => (
      <motion.div
        ...
        role="status"
        aria-live="polite"
        className="w-[calc(100vw-32px)] max-w-90 overflow-hidden rounded-[18px] border border-white/15 bg-lineat-to-br from-[#073D31] to-[#0A5745] text-white shadow-[0_18px_44px_rgba(7,61,49,0.25)]"
      >
